...
export async function POST(request: NextRequest) {
    ...
    const { collection, addDoc, serverTimestamp, doc, getDoc, updateDoc, setDoc, deleteDoc, getDocs, query, orderBy, limit, where, deleteField } = await import('firebase/firestore');
